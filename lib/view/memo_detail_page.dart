      ...
      body: Padding(
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              SizedBox(height: 24,),
              Text('種目名',style: TextStyle(color: Colors.grey,fontSize: 16,fontWeight: FontWeight.bold),),
              Text(memo.title,style: TextStyle(fontSize: 24,fontWeight: FontWeight.bold),),
              SizedBox(height: 8,),
              Text('部位',style: TextStyle(color: Colors.grey,fontSize: 16,fontWeight: FontWeight.bold),),
              Text(memo.part,style: TextStyle(fontSize: 24,fontWeight: FontWeight.bold),),
              SizedBox(height: 8,),
              Text('トレーニング種類',style: TextStyle(color: Colors.grey,fontSize: 16,fontWeight: FontWeight.bold),),
